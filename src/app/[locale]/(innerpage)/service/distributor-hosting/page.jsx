...
const page = () => {
  return (
    <div>
      ...
      <ServiceDetails
        namespace="ServiceDetails_DistributorHosting"
        bannerImage="/assets/distributor-banner.jpg"
        standardImageOne="/assets/distributorS1.jpg"
        standardImageTwo="/assets/distributorS2.jpg"
        useAnimatedBanner={true}
      />
      {/* <Services1 type="services" pageNumber={2}></Services1> */}
