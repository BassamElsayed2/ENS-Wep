                                ...
                                <div className="intro-content">
                                    <div className="intro-section-title">
                                        <div className="intro-subtitle wow fadeInUp" data-wow-delay=".4s">
                                            {safeParse(subtitle)} <Image src="/assets/images/icon/fireIcon.svg" alt="img" width={16} height={16}   />
                                        </div>
                                        <h1 className="intro-title wow fadeInUp" data-wow-delay=".2s">{safeParse(title)}</h1>
                                    </div>
